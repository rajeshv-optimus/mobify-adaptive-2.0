...
This repository contains the code for the via-magazine Adaptive.js project.
...
- **Project Slug**: via-magazine
- **Site URL**: http://www.viamagazine.com/
...
```
git clone https://github.com/<organization>/via-magazine.git
```
